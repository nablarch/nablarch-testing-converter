...
**要対応 22 件の内訳（修正済み 19 ／ 未完 3。2026-08-19 時点）**

- **修正済み 19 件** —— XLS-06・XLS-08・XLS-16・**XLS-20**・XLS-22・**XLS-28**・XLS-29・XLS-30・**XLS-31**・**XLS-32**・**XLS-33**・**XLS-34**・**XLS-35**・**XLS-36**・**XLS-37** ／
  YML-02・YML-03・YML-08・YML-12（**YML-12 は 4 形すべてが修正済み**）
- **未完 3 件** —— XLS-27・**XLS-38**・**XLS-40**
...
### XLS-38 コレクション・Map が `null`（および要素が `null`）の中間モデルが、辺③④のどちらでも手掛かりの無い `NullPointerException` になる（影響度 中・**検出できない（例外に手掛かりが無い）**）
