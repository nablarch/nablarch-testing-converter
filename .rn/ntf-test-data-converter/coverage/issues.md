...
変更はゼロである）。**#25.5 で方針が変わり、「NTF 仕様としての判定」が要対応とした 15 件のうち 10 件を
修正した**（2026-08-18 時点。steering Decisions「不具合修正の対象と手順（#25.5）」）。修正済みの課題は各項の
...
**要対応 24 件の内訳（修正済み 22 ／ 未完 2。2026-08-19 時点）**

- **修正済み 22 件** —— XLS-06・XLS-08・XLS-16・**XLS-20**・XLS-22・**XLS-28**・XLS-29・XLS-30・**XLS-31**・**XLS-32**・**XLS-33**・**XLS-34**・**XLS-35**・**XLS-36**・**XLS-37**・**XLS-38**・**XLS-40**・**XLS-41** ／
