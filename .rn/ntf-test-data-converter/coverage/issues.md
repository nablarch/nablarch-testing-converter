...
**要対応 23 件の内訳（修正済み 15 ／ 未完 8。2026-08-19 時点）**
...
- **未完 8 件** —— XLS-27・**XLS-34**・**XLS-35**・**XLS-36**・**XLS-37**・**XLS-38**・**XLS-40**・**XLS-41**
  - XLS-27 は当面の対応（0 件テーブルを弾く番人）まで完了（`57c1b0d`）。本体修正待ち。
    マーカーカラム案の実測は未実施
  - **XLS-34〜XLS-41 は §6（中間モデル一巡点検）で新たに起こした 8 件のうちの 7 件である**
...
### XLS-34 データ種別 `null` のデータブロックが、辺③④のどちらでも手掛かりの無い `NullPointerException` になる（影響度 中・**検出できない（例外に手掛かりが無い）**）
