...
**要対応 22 件の内訳（修正済み 18 ／ 未完 4。2026-08-19 時点）**

- **修正済み 18 件** —— XLS-06・XLS-08・XLS-16・**XLS-20**・XLS-22・**XLS-28**・XLS-29・XLS-30・**XLS-31**・**XLS-32**・**XLS-33**・**XLS-34**・**XLS-35**・**XLS-36** ／
  YML-02・YML-03・YML-08・YML-12（**YML-12 は 4 形すべてが修正済み**）
- **未完 4 件** —— XLS-27・**XLS-37**・**XLS-38**・**XLS-40**
...
### XLS-37 名前 `null` の読み込み単位から、辺③が `null.xlsx` というファイルを黙って作る（影響度 中・**検出できない**・**XLS-33 の器版**）
