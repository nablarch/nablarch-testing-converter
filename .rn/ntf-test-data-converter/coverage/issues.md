...
求めるため、起票だけを行った（実施は #28 の後に独立タスク #29 として立てる。**マージ前に片付ける** —— ユーザー確定・2026-08-21）。
...
- **#27 で起票し、まだ実施していない 1 件** —— **XLS-44**（中間モデルがファイル種別を `DataType` と
  ...
  求めるため、#27 では起票だけを行った。実施は #28 の後に独立タスク #29 として立てる。
  **#29 はマージ前に片付ける**（ユーザー確定・2026-08-21）。**
...
実施は #28 の後に独立タスク #29 として立てる。#29 はマージ前に片付ける**（ユーザー確定・2026-08-21。
...
- NTF 仕様としての判定: **要対応**（**未実施**。#27 では `src/main` を触らないため起票のみ）。
  ...
  **#25.5 で修正した 25 件とは別枠の、未実施の要対応である。実施は #28 の後に独立タスク（#29）として立てる。マージ前に片付ける**（ユーザー確定・2026-08-21）。
