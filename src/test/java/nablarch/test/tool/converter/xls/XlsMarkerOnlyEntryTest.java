 ...
 *
 * <p>
 * 入力は<b>他のカラムを持つブロック</b>で組む。カラム名がマーカーカラムだけのブロック（除外すると
 * カラム名が 0 件になるブロック）はデータ行を持たず、別の定めが当たる。そちらは
 * {@code XlsFormatReaderRealFileTest} と {@code XlsReferenceFixtureTest} が固定している。
 * </p>
 *
 * <p>
